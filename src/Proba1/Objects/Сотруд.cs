...
namespace IIS.Proba1
{
    ...
    public class Сотруд : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba1.DetailArrayOfТЧСотруд fТЧСотруд;
        ...
        public virtual IIS.Proba1.DetailArrayOfТЧСотруд ТЧСотруд
        {
            get
            {
                ...
                {
                    this.fТЧСотруд = new IIS.Proba1.DetailArrayOfТЧСотруд(this);
                }
                IIS.Proba1.DetailArrayOfТЧСотруд result = this.fТЧСотруд;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудE", typeof(IIS.Proba1.Сотруд));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудL", typeof(IIS.Proba1.Сотруд));
                }
            }
        }
    }
