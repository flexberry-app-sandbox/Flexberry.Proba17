...
namespace IIS.Proba1
{
    ...
    public class ТЧСотруд : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Proba1.Сотруд.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧСотрудE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧСотрудE", typeof(IIS.Proba1.ТЧСотруд));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧСотруд : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Proba1.DetailArrayOfТЧСотруд members)

        // *** End programmer edit section *** (IIS.Proba1.DetailArrayOfТЧСотруд members)
        ...
        /// </summary>
        public DetailArrayOfТЧСотруд(IIS.Proba1.Сотруд fСотруд) : 
                base(typeof(ТЧСотруд), ((ICSSoft.STORMNET.DataObject)(fСотруд)))
        {
        }
        
        public IIS.Proba1.ТЧСотруд this[int index]
        {
            get
            {
                return ((IIS.Proba1.ТЧСотруд)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Proba1.ТЧСотруд dataobject)
        {
