...
namespace IIS.Proba1
{
    ...
    [View("ПланирСобесE", new string[] {
            ...
            "РегистАнкеты.ВакантДолжн.Должность as \'Должность\'",
            "РегистАнкеты.НомерТелефона as \'Телефон\'",
            "РегистАнкеты.ЭлПочта as \'Эл почта\'"}, Hidden=new string[] {
    ...
    public class ПланирСобес : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba1.РегистАнкеты fРегистАнкеты;
        ...
        [PropertyStorage(new string[] {
                "РегистАнкеты"})]
        [NotNull()]
        public virtual IIS.Proba1.РегистАнкеты РегистАнкеты
        {
            get
            {
                ...
                IIS.Proba1.РегистАнкеты result = this.fРегистАнкеты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланирСобесE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланирСобесE", typeof(IIS.Proba1.ПланирСобес));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПланирСобесL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланирСобесL", typeof(IIS.Proba1.ПланирСобес));
                }
            }
        }
    }
